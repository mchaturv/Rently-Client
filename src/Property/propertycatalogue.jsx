...
class PropertyCatalogue extends Component {
  ...
  getFavourite() {
    ...
    if(auth)
    {
        ...
        axios.get(favapi, requestOptions).then(response => {
  ...
  deleteFavourite = (propertydetail) => {
    ...
    axios.delete(favapi, requestOptions).then(response => {
        var searchResult = response.data;
                        ...
                        <div className="property-list">
                          ...
                          {this.state.properties.map((item, index) =>
                            <PropertyCard key={index} id={index}
                              ...
                              onFavouriteClickAdd ={this.saveFavourite.bind(this,item)}
                              onFavouriteClickRemove ={this.deleteFavourite.bind(this,item)}
                              property={item}  favProperties ={this.state.favProperties} />
